...
class QuestionIndexViewTests(TestCase):
    ...
    def test_more_then_five_questions(self):
        """
        ...
        create_question(question_text="Past question 3.", days=-3)
        create_question(question_text="Past question 4.", days=-4)
        create_question(question_text="Past question 5.", days=-5)
        create_question(question_text="Past question 6.", days=-6)
        response = self.client.get(reverse('polls:index'))
